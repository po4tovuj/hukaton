...
export default class Habit extends Component {
    ...
    handleBasketClick = (evt) => {
        console.log(evt.target.classList.contains(styles.basket));
        evt.target.classList.toggle(styles.basket__orange);
        this.props.onDelete(auth.currentUser.uid, evt.target.id);
    };
    ...
    render() {
        ...
        return (
            <div className={styles.wrapper} onClick={this.handleBasketClick}>
                ...
                <div className={styles.basket} id={this.props.id} ></div>
            </div>
        );
    }
};
